...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .db-link{display:block; margin-top:12px; padding:9px 12px; border-radius:10px; font-size:13px; font-weight:600;
    text-align:center; color:#fff; background:linear-gradient(90deg,var(--brand),var(--brand2))}
  .db-link:hover{text-decoration:none; opacity:.92}
...
<div class="app">
  <aside class="sidebar" id="sidebar">
    <div class="brand">
      ...
      <a class="db-link" href="db.html">&#128269; Explorador de Dados (itens, npcs, receitas...)</a>
    </div>
